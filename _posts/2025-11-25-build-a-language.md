...
- No garbage collection of any kind: we _just use malloc_. We could
...
_passes_. Each pass transforms an input language into an output
...
_always_ want to localize errors to the proximate pass which causes

...
revealed to be nothing more than Claude in a loop with command-line
tools. The 2023-era copy-and-pasting into the textbox, manually
crafting a prompt, and carefully stitching the result into our
codebase feels downright manual by comparison. Now, we can boot up
...
domain: Claude Code shows that doing that for arbitrarily-complex
...
In some ways, I see LLM-assisted software engineering as the 2020's
Object Orientation: it offers a vast swath of opportunity to give
...
abstraction, but we should be wary and remember to build our own
mental models. They are often very good at decomposing structure, but
much weaker at constructing the semantics that make those structures
meaningful: thus, I recommend you focus on semantics throughout your
study. When I was learning to program, I remember feeling often: "I
can write 100-500 line programs, how do I write a 1M-line program?"
The answer is that we have to develop abstract reasoning: almost no
developer would literally read every single line of a large software
system. One crucial skill software engineering students learn is how
...
where generators are perfect, what is the role of the verifiers? This
is an apt question.
